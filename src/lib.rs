...
fn encode_rc5_32_12_16(key: Vec<u8>, plaintext: Vec<u8>) -> Vec<u8> {
...
fn decode_rc5_32_12_16(key: Vec<u8>, ciphertext: Vec<u8>) -> Vec<u8> {
	let rc5 = RC5::new(12, 0xB7E15163_u32, 0x9E3779B9_u32);
...
mod rc5_32_12_16_tests {
    ...
    fn encode_decode() {
    	...
    	let res = encode_rc5_32_12_16(key.clone(), pt.clone());
		let res = decode_rc5_32_12_16(key, res);
    	assert!(&pt[..] == &res[..]);
    }
	...
	fn encode_empty_message() {
		...
		let key = vec![0x00; 16];
    	let pt  = vec![0x00; 8];
    	let res = encode_rc5_32_12_16(key, pt.clone());
    ...
    fn encode_a() {
    	...
    	let res = encode_rc5_32_12_16(key, pt);
    	assert!(&ct[..] == &res[..]);
    }
    ...
    fn decode_a() {
    	...
    	let res = decode_rc5_32_12_16(key, ct);
    	assert!(&pt[..] == &res[..]);
    }
